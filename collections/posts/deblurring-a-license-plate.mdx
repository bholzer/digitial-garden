...
import blurred from '../../src/images/posts/deblur/blurred.png';
import seedKernel from '../../src/images/posts/deblur/seed_kernel.png';
import deblurredSeedKernel from '../../src/images/posts/deblur/deblurred_seed_kernel.png';
import refinedKernel from '../../src/images/posts/deblur/refined_kernel.png';
import deblurredRefinedKernel from '../../src/images/posts/deblur/deblurred_refined_kernel.png';
...
<figure>
  <Image src={blurred} alt="Motion-blurred license plate" />
...
<figure>
  <Image src={seedKernel} alt="Straight-line motion blur kernel" />
...
<figure>
  <Image src={deblurredSeedKernel} alt="Deblurred license plate with initial kernel" />
...
<figure>
  <Image src={refinedKernel} alt="Refined kernel after 20 rounds" />
...
<figure>
  <Image src={deblurredRefinedKernel} alt="Deblurred license plate" />
